...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, data, temp, humi, press, airq, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, getData_1.getDataRecent)()];
            case 1:
                response = _a.sent();
                data = JSON.parse(response);
                temp = data.row.temperature;
                humi = data.row.humidity;
                press = data.row.pressure;
                airq = data.row.airquality;
